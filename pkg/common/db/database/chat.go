...
import (
	...
	admin2 "github.com/BioforestChain/dweb-browser-im-chats/pkg/common/db/model/admin"
	"github.com/BioforestChain/dweb-browser-im-chats/pkg/common/db/model/chat"
	"github.com/BioforestChain/dweb-browser-im-chats/pkg/common/db/table/admin"
	table "github.com/BioforestChain/dweb-browser-im-chats/pkg/common/db/table/chat"
