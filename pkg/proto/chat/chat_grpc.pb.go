...
const (
	Chat_GetUserByAddress_FullMethodName     = "/OpenIMChat.chat.chat/GetUserByAddress"
	...
	Chat_RegisterDwebUser_FullMethodName     = "/OpenIMChat.chat.chat/RegisterDwebUser"
...
func (c *chatClient) GetUserByAddress(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*GetUserResp, error) {
	out := new(GetUserResp)
	err := c.cc.Invoke(ctx, Chat_GetUserByAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) RegisterDwebUser(ctx context.Context, in *RegisterDwebUserReq, opts ...grpc.CallOption) (*RegisterUserResp, error) {
	out := new(RegisterUserResp)
	err := c.cc.Invoke(ctx, Chat_RegisterDwebUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Chat_GetUserByAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_GetUserByAddress_FullMethodName,
	}
...
func _Chat_RegisterDwebUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_RegisterDwebUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
